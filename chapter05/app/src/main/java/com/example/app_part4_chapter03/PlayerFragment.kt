...
import com.example.app_part4_chapter03.databinding.FragmentPlayerBinding
            ...
            override fun onTransitionChange(
                ...
                binding?.let {
                    (activity as MainActivity).also { mainActivity ->
                        mainActivity.findViewById<MotionLayout>(R.id.mainContainerLayout).progress = kotlin.math.abs(progress)
                    }
                }
            }
